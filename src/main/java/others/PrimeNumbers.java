...
/**
 * Count number of primes lesser than n and also print all primes
 *
 * Created by sharath on 8/14/15.
 */
// Using the sieve of Eratosthenes to calculate number of primes less than n
public class PrimeNumbers {
    ...
    public static void main(String[] args) {
        List<Integer> calcPrimeNumbers = calcPrimeNumbers(19);
